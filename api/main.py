...
for repo in repos:
    ...
    relevant_repos.append((repo_name, commits_count, issues_count))

    # Create summary text file
    summary_path = f'{repositories_dir}/{repo_name}/summary.txt'
    ...
    print("Summary file saved for repository:", repo_name)
...
with open(summary_file_path, 'w') as summary_all_file:
    for repo_info in relevant_repos:
        repo_name, total_commits, total_issues = repo_info
